...
export function AuroraBackdrop() {
  return (
    <div
      ...
      aria-hidden
    >
      <div className="absolute inset-0 bg-gradient-to-b from-[#050a14] via-[#0B1F3A] to-[#030712]" />
      <motion.div
        className="absolute -left-1/4 top-0 h-[70vh] w-[70vw] rounded-full bg-[#00E676]/15 blur-[120px]"
        animate={{ opacity: [0.35, 0.55, 0.35], scale: [1, 1.05, 1] }}
        transition={{ duration: 14, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        className="absolute -right-1/4 bottom-0 h-[60vh] w-[60vw] rounded-full bg-cyan-500/10 blur-[100px]"
      ...
      />
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_rgba(0,230,118,0.08),_transparent_55%)]" />
    </div>
  );
}
