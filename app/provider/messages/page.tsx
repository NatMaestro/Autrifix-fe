...
export default function ProviderMessagesEntryPage() {
    ...
    return (
      <div className="flex min-h-[70dvh] items-center justify-center px-4">
        <GlassCard className="max-w-md border-slate-300/70 bg-white/95 text-center dark:border-white/10 dark:bg-[#1a2437]/90">
          ...
          <p className="mt-2 text-base font-semibold text-slate-900 dark:text-white">No active chats yet</p>
          <p className="mt-1 text-sm text-slate-600 dark:text-white/60">
            You currently have no connected customer chat contacts.
          </p>
          <div className="mt-4">
            <Link href="/provider">
