...
export default function ChatPage() {
  ...
  const hasConnectedProviders = contacts.length > 0;
      ...
      <div className="grid h-full min-h-0 gap-3 lg:grid-cols-[280px_1fr]">
                ...
                return (
                  ...
                  >
                    <p className="text-sm font-semibold text-slate-900 dark:text-white">
                      {room.contact_name || "Assigned provider"}
                    </p>
        ...
        <div className="flex h-full min-h-0 flex-col overflow-hidden">
          <div className="mb-3 flex items-center justify-between">
            <Link href="/customer/messages" className="lg:hidden">
            ...
            <Link href="/customer/in-progress">
              <Button size="sm" variant="ghost">
          ...
          <div className="mt-3 flex items-end gap-2">
            ...
            <textarea
              ...
              rows={1}
              placeholder={hasConnectedProviders ? "Message…" : "No active chat yet"}
              ...
              disabled={!hasConnectedProviders}
            />
            <Button type="button" className="!px-4" onClick={send} disabled={sending || !hasConnectedProviders}>
